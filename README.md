...
to install it, you need to create a folder in the assets folder of called Mono. put a Managed.zip in there that directly contains all your dlls. and put mono.zip, it stores the config and the native libs.
